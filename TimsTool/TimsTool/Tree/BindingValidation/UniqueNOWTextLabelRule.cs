...
{
    public class UniqueNowTextLabelRule : ValidationRule
    {
        public override ValidationResult Validate(object value, CultureInfo cultureInfo)
        {
            ...
            var nowTextList = selectedNow.NowViewModel.Now.NowTextList;
            if (nowTextList != null)
            {
                var matchedLabel = nowTextList.Find(x => x.Reference.Trim().ToLowerInvariant() == label.ToLowerInvariant());
